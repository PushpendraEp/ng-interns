...
@Component({
  selector: 'app-dynamic-table-column-home',
  templateUrl: './dynamic-table-column-home.component.html',
  styleUrls: ['./dynamic-table-column-home.component.css']
})
export class DynamicTableColumnHomeComponent {
